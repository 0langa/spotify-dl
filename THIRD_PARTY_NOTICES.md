...
Playlist DL bundles or depends on following projects. Exact resolved Python versions live in `backend/uv.lock`.
...
Bundled executable remains GPL-3.0 because distributed backend includes SpotAPI. Copyright remains with each project and contributor. No trademark endorsement implied.
